...
public class TablesBeanListServlets extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // MemberBean memberBean = datasInfor.getDataToMemberBean();   
        ...
        // printWriter.println("<div class = 'fs-3'>"+memberBean.getFirstName() + memberBean.getsecondName() + memberBean.getHandleName()+"</div>");
        printWriter.println("<div class = 'fs-3'>"+memberBean2.getFirstName() + memberBean2.getsecondName() + memberBean2.getHandleName()+"</div>");
