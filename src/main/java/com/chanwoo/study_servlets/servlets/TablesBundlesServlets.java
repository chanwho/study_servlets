...
@WebServlet(urlPatterns = "/tablesBundlesServlets")
public class TablesBundlesServlets extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) 
        ...
        ArrayList<String> tablesListWithString = (ArrayList<String>) bundleData.get("tablesListWithString");

        datasInfor.getBundlesData();
        ...
        printWriter.println("<div class='fs-3'>Tables With Getbundle</div>");
